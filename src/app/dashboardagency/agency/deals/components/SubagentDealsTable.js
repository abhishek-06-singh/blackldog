...
const getMenu = (member) => (
  <Menu className="!bg-cardbg [&_.ant-dropdown-menu-item]:!text-textnormal [&_.ant-dropdown-menu-item:hover]:!bg-buttonbg [&_.ant-dropdown-menu-item:hover]:!text-background">
    <Menu.Item key="1" onClick={() => alert(`Edit ${member.member}`)}>Edit</Menu.Item>
    <Menu.Item key="2" onClick={() => alert(`Delete ${member.member}`)}>Delete</Menu.Item>
    <Menu.Item key="3" onClick={() => alert(`View property: ${member.property.name}`)}>View Property</Menu.Item>
  </Menu>
)
          ...
          <tbody className="divide-y divide-bordercolor">
            {currentItems.map((item) => (
              <tr key={item.id} className="hover:bg-boxbg transition">
                ...
                {/* Agent */}
                <td className="pr-16 md:pr-12 md:p-4 whitespace-nowrap">
                ...
                {/* Deal Title */}
                <td className="p-4 text-sm font-medium whitespace-nowrap text-textnormal">{item.title}</td>
                ...
                {/* Property */}
                <td className="whitespace-nowrap pr-16 md:pr-20 md:p-4">
                  <div className="flex items-center gap-3 w-full">
                    <img
                ...
                {/* Deal Value */}
                <td className="p-4 text-sm text-textnormal">{item.dealValue}</td>

                {/* Closing Date */}
                <td className="p-4 text-sm text-textnormal">{item.date}</td>

                {/* Commission */}
                <td className="p-4 text-sm  text-textnormal">{item.commission}</td>
