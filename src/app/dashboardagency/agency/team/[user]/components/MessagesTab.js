            ...
            >
              ...
              <div className="flex items-start sm:items-center gap-3 w-full sm:w-auto pr-4 sm:pr-16">
                ...
                <div className="flex flex-col min-w-0">
                  <div className="font-semibold text-textheading whitespace-nowrap">
              ...
              <div className="flex items-center gap-3 mt-4 sm:mt-0 sm:ml-auto shrink-0">
                <span className="text-sm text-textnormal whitespace-nowrap">
                  {msg.time}
                </span>
                <button className="bg-buttonbg text-background px-5 sm:px-7 py-2 rounded-lg text-sm hover:scale-95 transition-transform whitespace-nowrap">
                  Open Conversation
                </button>
              </div>
            </div>
