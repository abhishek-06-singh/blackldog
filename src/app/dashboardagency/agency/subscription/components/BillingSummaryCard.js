...
export default function BillingSummaryCard() {
  return (
    <div className="bg-cardbg border border-bordercolor rounded-xl p-6 shadow-md w-full">
      ...
      <div className="flex flex-col justify-center sm:flex-row sm:justify-between items-center py-2 ">
        <span className="text-sm text-textnormal">Next Payment Amount</span>
        <span className="text-sm font-medium text-textheading">$199</span>
      </div>
      ...
      <div className="flex justify-between items-center py-2 ">
        <span className="text-sm text-textnormal">Billing Cycle</span>
