          ...
          <Row gutter={[24, 2]}> 
            ...
            <Col xs={24} sm={12}>
              <Form.Item className='font-semibold no-label-margin' label={<span className='text-textnormal'>Deal Title*</span>} name="dealTitle" rules={[{  message: 'Please enter deal title' }]}>
                <Input  placeholder="Enter Deal Title" className="rounded-xl h-10 !bg-cardbg !text-textnormal !focus:ring-0 !focus:border-textnormal !border-bordercolor !shadow-none !outline-none" />
              </Form.Item>
            </Col>
            ...
            <Col xs={24} sm={12}>
              <Form.Item className='font-semibold no-label-margin' label={<span className='text-textnormal'>Property*</span>} name="property">
                <Select  dropdownClassName="bg-cardbg border border-bordercolor [&_.ant-select-item-option-selected]:!bg-buttonbg [&_.ant-select-item-option-selected]:!text-background [&_.ant-select-item-option-active]:!bg-buttonbg [&_.ant-select-item-option-active]:!text-background"
            ...
            suffixIcon={<ChevronDown className="w-4 h-4 text-textnormal" />}placeholder="Select property" allowClear>
            ...
            <Col xs={24} sm={12}>
              <Form.Item className='font-semibold no-label-margin' label={<span className='text-textnormal'>Deal Value*</span>} name="dealValue" rules={[{  message: 'Please enter deal value' }]}>
                <Input className="rounded-xl h-10 !bg-cardbg !text-textnormal !focus:ring-0 !focus:border-textnormal !border-bordercolor !shadow-none !outline-none" placeholder="Enter Deal Value" />
              </Form.Item>
            </Col>
            ...
            <Col xs={24} sm={12}>
              <Form.Item className='font-semibold no-label-margin' label={<span className='text-textnormal'>Deal Stage*</span>} name="dealStage" rules={[{  message: 'Please select deal stage' }]}>
                <Select  dropdownClassName="bg-cardbg border border-bordercolor [&_.ant-select-item-option-selected]:!bg-buttonbg [&_.ant-select-item-option-selected]:!text-background [&_.ant-select-item-option-active]:!bg-buttonbg [&_.ant-select-item-option-active]:!text-background"
            className="w-full h-10 [&_.ant-select-selector]:!bg-cardbg [&_.ant-select-selector]:!rounded-xl [&_.ant-select-selector]:!border-bordercolor [&_.ant-select-selection-item]:!text-textnormal [&_.ant-select-selector]:!focus:border-textnormal [&_.ant-select-selector]:!ring-0"
            suffixIcon={<ChevronDown className="w-4 h-4 text-textnormal" />} defaultValue="New">
            ...
            <Col xs={24} sm={12}>
              <Form.Item className='font-semibold no-label-margin' label={<span className='text-textnormal'>Expected Closing Date</span>} name="closingDate">
                <DatePicker className="w-full h-10 rounded-xl !bg-cardbg !border-bordercolor !focus:border-textnormal !ring-0" style={{ width: '100%' }} placeholder="Select Date" />
              </Form.Item>
            </Col>
          </Row>
        </Form>
