    ...
    <div className="bg-cardbg px-4 pt-4 pb-6 rounded-xl border border-bordercolor shadow-md w-full mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center mb-4">
        ...
        <div className="space-y-4 md:space-x-2">
          <Button
            icon={<PlusOutlined />}
            className="w-full mb-2 md:mb-0 !h-9 !rounded-xl border border-bordercolor bg-buttonbg text-background"
          >
            Add New Contact
          </Button>
          <Button
            ...
            className="w-full !h-9 !rounded-xl bg-buttonbg text-background border-none"
          >
            + Add Agent
          </Button>
        </div>
