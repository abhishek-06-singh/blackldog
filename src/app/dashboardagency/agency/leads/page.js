...
import StatsCard_Leads from './components/AgentLeads/StatsCard_Leads'
            ...
            <>
              <div className="px-4 md:px-10 mt-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="w-full md:w-auto bg-background border border-bordercolor text-textnormal p-2 rounded-lg flex text-sm justify-center items-center gap-2 hover:scale-95 transition-transform"
                >
                  <Upload className="w-4 h-4" /> Export Leads
                </button>
                <button
                  onClick={() => setShowNewLeads(true)}
