      ...
      <div className="p-6 bg-cardbg rounded-xl shadow-md border border-bordercolor w-full">
        ...
        >
          ...
          >
            ...
            <Col span={12}>
              <Form.Item
                label={<span className='text-textnormal'>Property Status</span>}
                 name="propertyStatus"
            className="text-textheading font-semibold"
          >
            <Select placeholder="Select Property Status"  dropdownClassName="bg-cardbg border border-bordercolor [&_.ant-select-item-option-selected]:!bg-buttonbg [&_.ant-select-item-option-selected]:!text-background [&_.ant-select-item-option-active]:!bg-buttonbg [&_.ant-select-item-option-active]:!text-background"
            className="w-full h-10 [&_.ant-select-selector]:!bg-cardbg [&_.ant-select-selector]:!rounded-xl [&_.ant-select-selector]:!border-bordercolor [&_.ant-select-selection-item]:!text-textnormal [&_.ant-select-selector]:!focus:border-textnormal [&_.ant-select-selector]:!ring-0"
            suffixIcon={<ChevronDown className="w-4 h-4 text-textnormal" />}>
              <Select.Option value="forSale">For Sale</Select.Option>
              <Select.Option value="forRent">For Rent</Select.Option>
            </Select>
              </Form.Item>
            </Col>
          </Row>
...
>
          ...
          <Form.Item
                label={<span className='text-textnormal'>Assign to Agent</span>}
                 name="assignToAgent"
            className="text-textheading font-semibold"
          >
            <Select placeholder="Assign to Agent"  dropdownClassName="bg-cardbg border border-bordercolor [&_.ant-select-item-option-selected]:!bg-buttonbg [&_.ant-select-item-option-selected]:!text-background [&_.ant-select-item-option-active]:!bg-buttonbg [&_.ant-select-item-option-active]:!text-background"
            className="w-full h-10 [&_.ant-select-selector]:!bg-cardbg [&_.ant-select-selector]:!rounded-xl [&_.ant-select-selector]:!border-bordercolor [&_.ant-select-selection-item]:!text-textnormal [&_.ant-select-selector]:!focus:border-textnormal [&_.ant-select-selector]:!ring-0"
            suffixIcon={<ChevronDown className="w-4 h-4 text-textnormal" />}>
