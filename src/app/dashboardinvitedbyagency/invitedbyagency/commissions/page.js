...
import CommissionInfoBox from './components/CommissionBox'
import StatsCards_Commission from './components/StatsCards_Commission'
    ...
    >
      ...
      {Commissions ? (
        ...
        <>
          ...
          {!showNewCommissions ? (
            <>
              <div className="md:ml-6 mb-6 mt-6 h-10 flex p-2 md:pr-6 justify-between">
                <Heading
                  title="Commissions"
                  subtitle={
              ...
              <div className="mt-8 space-y-6">
                ...
                {activeTab === 'my' && (
                 ...
                 <StatsCards_Commission />
                <CommissionsTabs activeTab={activeTab} setActiveTab={setActiveTab} />
              </div>
            </>
          ) : (
