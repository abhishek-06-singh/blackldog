    ...
    <div className="w-full bg-cardbg rounded-2xl shadow-md border border-bordercolor p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-y-6">
        ...
        <div className="lg:col-span-6 w-full flex flex-col justify-end mt-4 sm:mt-0">
          ...
          <label className="text-sm text-textheading mb-1">Select Sub-Agent</label>
          <Select
            value={type}
            onChange={setType}
          ...
          >
            ...
            <Option value="house" className="!text-textnormal">Michal Chen</Option>
            <Option value="apartment" className="!text-textnormal">Michal Chen</Option>
            <Option value="apartment" className="!text-textnormal">Michal Chen</Option>
          </Select>
        </div>
...
export default AllComissionsFilter
