...
import Users from '../../../components/icons/Lightmode_icons/stats_icons/clipboard-light.svg'
import lockopen from '../../../components/icons/Lightmode_icons/stats_icons/lockopen-light.svg'
import verified from '../../../components/icons/Lightmode_icons/stats_icons/verified-light.svg'
import hourglass from '../../../components/icons/Lightmode_icons/teams/trophy.svg'
const statsData = [
  {
    id: 1,
  ...
  {
    id: 4,
    title: 'Access Type (Temporary)',
    value: '3 days left',
    icon: <Image src={hourglass} className="w-6 h-6 text-black-400" />,
  },
]

export default function StatsCards_Commission({ data = statsData }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-3 pr-2 ml-2 lg:ml-6 lg:pr-6">
      {data.map((stat, index) => (
        <motion.div
          key={stat.id}
