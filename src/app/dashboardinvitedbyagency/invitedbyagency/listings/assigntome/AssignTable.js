              ...
              >
                ...
                <td className="p-2 sm:p-4 flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="font-medium text-sm text-textnormal truncate">
                      {property.name}
                    </div>
                ...
                <td className="p-2 sm:p-4">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm">{property.listedBy.name}</span>
                  </div>
                </td>
                <td className="p-2 sm:p-4">
                  <span
                ...
                <td className="p-2 sm:p-4 text-sm text-textnormal whitespace-nowrap">
                  {property.date}
                </td>
                <td className="p-2 sm:p-4">
                  <Dropdown
