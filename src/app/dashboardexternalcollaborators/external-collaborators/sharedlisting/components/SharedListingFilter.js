      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-y-6">
        ...
        <div className="lg:col-span-4 w-full flex flex-col justify-end mt-4 sm:mt-0">
          ...
          >
            ...
            <Option value="house" className="!text-textnormal">Property Type 1</Option>
            <Option value="apartment" className="!text-textnormal">Property Type 2</Option>
            <Option value="apartment" className="!text-textnormal">Property Type 3</Option>
          </Select>
        </div>
          <div className="lg:col-span-2 w-full flex flex-col mt-4 sm:mt-0">
          <label className="text-sm text-textheading mb-1">Bedrooms</label>
          <Select
            value={bedrooms}
          ...
          <div className="lg:col-span-2 w-full flex flex-col mt-4 sm:mt-0">
          <label className="text-sm text-textheading mb-1">Bathrooms</label>
          <Select
            value={bathrooms}
...
export default SharedListingFilters
