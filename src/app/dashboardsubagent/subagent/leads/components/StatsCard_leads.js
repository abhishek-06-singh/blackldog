...
export default function StatsCardLeads({ data = statsData }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-3 ml-2 md:ml-6 pr-2 md:pr-6">
      {data.map((stat, index) => (
        <motion.div
          key={stat.id}
