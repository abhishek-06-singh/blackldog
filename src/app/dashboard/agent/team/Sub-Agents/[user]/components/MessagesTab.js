...
export default function MessagesTab() {
  return (
    <div className="mt-8">
      <h2 className="text-xs sm:text-sm md:text-lg text-textheading font-semibold mb-4">
        ...
        <div className="min-w-[600px]"> {/* Ensures horizontal scroll on small screens */}
          {messages.map((msg, index) => (
            <div
              key={msg.id}
              className={`
                flex flex-row items-center justify-between p-4 transition 
            ...
            >
              ...
              <div className="flex items-start sm:items-center gap-3 w-full sm:w-auto pr-4 sm:pr-16">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <div className="text-sm text-textnormal truncate max-w-[12rem] sm:max-w-[16rem] md:max-w-md">
                    {msg.message}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 mt-4 sm:mt-0 sm:ml-auto shrink-0">
                ...
                <button className=" font-medium bg-buttonbg text-background px-5 sm:px-7 py-2 rounded-lg text-xs md:text-sm hover:scale-95 transition-transform whitespace-nowrap">
                  Open Conversation
                </button>
              </div>
            </div>
