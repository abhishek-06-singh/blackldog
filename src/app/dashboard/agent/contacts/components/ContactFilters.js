  ...
  return (
    <div className="w-full bg-cardbg rounded-2xl shadow-md border border-bordercolor p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-y-6">
        {/* Search */}
        <div className="lg:col-span-4 w-full flex flex-col justify-end mt-4 sm:mt-0">
          <Input
            prefix={<SearchOutlined />}
            placeholder="Search by name, email or listing"
            className="rounded-xl h-10 !text-xs md:!text-sm !bg-cardbg !text-textnormal !focus:ring-0 !focus:border-textnormal !border-bordercolor !shadow-none !outline-none"
          />
        </div>
        ...
        <div className="lg:col-span-3 w-full flex flex-col mt-4 sm:mt-0">
          ...
          >
            ...
            <Option value="house" className="!text-textnormal !text-xs md:!text-sm">New</Option>
            <Option value="apartment" className="!text-textnormal !text-xs md:!text-sm">Negotiation</Option>
            <Option value="apartment" className="!text-textnormal !text-xs md:!text-sm">Closed</Option>
          </Select>
        </div>
        
        <div className="lg:col-span-2 w-full flex flex-col mt-4 sm:mt-0">
          <label className="text-sm text-textheading mb-1">Tags</label>
          <Select
            value={type}
            onChange={setType}
              dropdownClassName=" bg-cardbg border border-bordercolor [&_.ant-select-item-option-selected]:!bg-buttonbg [&_.ant-select-item-option-selected]:!text-background [&_.ant-select-item-option-active]:!bg-buttonbg [&_.ant-select-item-option-active]:!text-background"
          ...
          >
            <Option value="all" className="!text-textnormal !text-xs md:!text-sm ">All</Option>
            <Option value="house" className="!text-textnormal !text-xs md:!text-sm">VIP</Option>
            <Option value="apartment" className="!text-textnormal !text-xs md:!text-sm">Potential Collaborator</Option>
            <Option value="apartment" className="!text-textnormal !text-xs md:!text-sm">Follow Up Needed</Option>
          </Select>
        </div>
