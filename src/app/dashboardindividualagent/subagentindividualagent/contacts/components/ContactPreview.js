...
export default function ContactPreview({ contacts }) {
  ...
  const handleClick = (name) => {
    router.push(`/dashboardindividualagent/subagentindividualagent/contacts/${encodeURIComponent(name)}`);
  };
            ...
            >
              ...
              <div className="flex flex-1 flex-row justify-between items-center">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-textnormal font-semibold">{contact.name}</span>
                  <Tag
