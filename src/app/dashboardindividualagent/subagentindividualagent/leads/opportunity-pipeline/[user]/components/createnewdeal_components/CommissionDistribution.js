  ...
  return (
    <div className="bg-cardbg px-4 pt-4 pb-6 rounded-xl border border-bordercolor shadow-md w-full mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center mb-4">
        <h3 className="text-lg mb-4 md:mb-0 font-semibold whitespace-nowrap text-textnormal">Commission Distribution</h3>
        <div className="flex flex-col md:flex-row md:items-center md:justify-end space-y-4 md:space-y-0 md:space-x-2 w-full">
  <Button
    icon={<PlusOutlined />}
    className="w-full md:w-auto !h-9 !rounded-xl border border-bordercolor bg-cardbg text-textnormal"
  >
    Add New Contact
  </Button>
  <Button
    onClick={handleAddRow}
    className="w-full md:w-auto !h-9 !rounded-xl bg-buttonbg text-background border border-bordercolor"
  >
    + Add Agent
  </Button>
</div>
