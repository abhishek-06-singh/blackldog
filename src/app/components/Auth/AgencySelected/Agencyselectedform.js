...
export default function AgencySelectedForm() {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto my-10 p-6">
      ...
      <div className="w-full flex items-center my-10 p-6 bg-white border justify-center rounded-xl">
        <div className="w-full flex flex-col">
          <div className="w-full flex items-center justify-center my-10">
            <SetupHeading 
              title={"Create Your Account"}
              desc={"Join thousands of real estate professionals growing their business"} 
            />
          </div>
          ...
          <Agencyaccountinfo />
          <BackContinue back_link={"/signin"} Continue_link={"/agencydocs"} />
        </div>
      </div>
    </div></motion.div>
  );
